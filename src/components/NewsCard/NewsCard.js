  ...
  return (
    <Card ref={elRefs[i]} className={activeArticle === i ? classes.activeCard:classes.card}>
      <CardActionArea href={url} >
        <CardMedia className={classes.media} image={urlToImage || "https://img.freepik.com/free-vector/news-concept-landing-page_52683-20706.jpg?w=2000"} title={title} />
        ...
        <Typography className={classes.title} gutterBotom variant='h5' component="h2">
            {title}
          </Typography>
          <CardContent>
